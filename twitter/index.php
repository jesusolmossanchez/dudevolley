...
setcookie("oauth_token", $request_token['oauth_token'], time()+3600,'/','www.dudevolley.com');
setcookie("oauth_token_secret", $request_token['oauth_token_secret'], time()+3600,'/','www.dudevolley.com');
