...
DudeVolley.GameMultiplayer.prototype = {
	...
	socket = io.connect("https://dudevolley.com:8080", {port: 8080, transports: ["websocket"],secure: true});
    ...
    procesapunto: function () {
        ...
        if(this.pelota.body.position.x > 390){
            ...
            if (this.game.puntosPlayer2 >= 15){
                socket.emit("game_over", {ganador: OTROPLAYER.nombre, ganador_id: OTROPLAYER.id, perdedor: Player1.nombre, perdedor_id: Player1.id, room: window.te_reto});
            }
        }
