<form id="subefoto" class="clickable" action="sube2.php" method="post" enctype="multipart/form-data" style="display:none;">
	<div id="explica_sube">
    ...
    <input id="inputsubefoto" class="clickable" type="submit" value="Aceptar" name="submit" style="display:none">
</form>

<div id="contiene_foto_subida" class="clickable" style="max-width:600px;">
