        ...
        ***********************************************************************/
        ...
        function onSocketConnected() {
            ...
            $("#socket_empezar").click(function(){
                socket.emit("ready_controller", {id_socket: id_socket});
            });
        ...
        function setEventHandlers() {
            ...
            // Socket connection successful
            socket.on("conectado_room", onConectadoRoom);
    ...
    update: function () {
        ...
        ***********************************************************************/                      
            ...
            if(this.click_accion){
                socket.emit("boton", {id: window.id_socket, room: window.room});
            }
